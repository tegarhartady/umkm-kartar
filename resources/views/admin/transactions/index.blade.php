...
<style>
    ...
    .badge-soft-success { background-color: #e6fffa; color: #38a169; }
    .badge-soft-warning { background-color: #fffaf0; color: #dd6b20; }
    .badge-soft-danger { background-color: #fff5f5; color: #e53e3e; }
    .badge-soft-secondary { background-color: #f7fafc; color: #718096; }
    ...
    .btn-outline-primary { border-color: #4299e1; color: #4299e1; }
    .btn-outline-primary:hover { background-color: #4299e1; color: white; }
    
    .btn-outline-danger { border-color: #feb2b2; color: #e53e3e; }
    .btn-outline-danger:hover { background-color: #e53e3e; color: white; border-color: #e53e3e; }

    .btn-outline-info { border-color: #bee3f8; color: #3182ce; }
    .btn-outline-info:hover { background-color: #3182ce; color: white; border-color: #3182ce; }
